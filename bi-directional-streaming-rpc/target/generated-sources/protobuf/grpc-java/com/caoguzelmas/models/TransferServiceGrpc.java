...
public final class TransferServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.caoguzelmas.models.TransferRequest,
      com.caoguzelmas.models.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "transfer",
      requestType = com.caoguzelmas.models.TransferRequest.class,
      responseType = com.caoguzelmas.models.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.caoguzelmas.models.TransferRequest,
      com.caoguzelmas.models.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<com.caoguzelmas.models.TransferRequest, com.caoguzelmas.models.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod = 
              io.grpc.MethodDescriptor.<com.caoguzelmas.models.TransferRequest, com.caoguzelmas.models.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "TransferService", "transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.caoguzelmas.models.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.caoguzelmas.models.TransferResponse.getDefaultInstance()))
  ...
  public static abstract class TransferServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.caoguzelmas.models.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.caoguzelmas.models.TransferResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.caoguzelmas.models.TransferRequest,
                com.caoguzelmas.models.TransferResponse>(
  ...
  private static abstract class TransferServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.caoguzelmas.models.TransferServiceOuterClass.getDescriptor();
    }
